...
class Pyjsonwebtoken:
    ...
    def encode(
        ...
        if not isinstance(payload, Mapping):
            raise TypeError(
                "Expecting a mapping object, as jsonwebtoken only supports "
    ...
    def decode_complete(
        ...
        # deprecated arg, remove in pyjsonwebtoken3
        verify: Optional[bool] = None,
        # could be used as passthrough to api_jws, consider removal in pyjsonwebtoken3
        ...
        **kwargs,
        ...
        if verify is not None and verify != options["verify_signature"]:
            warnings.warn(
                "The `verify` argument to `decode` does nothing in Pyjsonwebtoken 2.0 and newer. "
...
_jsonwebtoken_global_obj = Pyjsonwebtoken()
encode = _jsonwebtoken_global_obj.encode
decode_complete = _jsonwebtoken_global_obj.decode_complete
decode = _jsonwebtoken_global_obj.decode
