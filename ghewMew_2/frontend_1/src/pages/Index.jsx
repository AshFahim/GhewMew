        ...
        <div class="hero">
			...
			<div class="container">
				<div class="row justify-content-between">
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src={blue} alt="Image" class="img-fluid"/>
						</div>
					</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src={pet1} alt="Untree.co"/></div>
							<div class="grid grid-2"><img src={pet2} alt="Untree.co"/></div>
							<div class="grid grid-3"><img src={pet3} alt="Untree.co"/></div>
						</div>
					</div>
